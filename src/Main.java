...
public class Main {
    ...
    public static String calc(String expr)
        ...
        if (cnt != 1) {
            throw new Exception("throws Exception: the format of the mathematical operation does not satisfy the task");
        }
        ...
        if (isRome && result <= 0) {
            throw new Exception("throws Exception: there are no negative numbers in the roman system");
        } else if (isRome) {
    ...
    public static void main(String[] args) {
        System.out.println("Please, enter a mathematical operation with two operands of the same number system (arabic or roman) and one operator (+, -, /, *): ");
